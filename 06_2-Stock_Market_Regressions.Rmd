...
knitr::include_graphics("./Images/06_2-correlations_v2.png")
```
...
# Let's Analyze the Market in 2021
```{r, fig.align = 'center', out.width = '80%'}
knitr::include_graphics("./Images/06-2-spreadsheet.png")
```
...
knitr::include_graphics("./Images/06-2-calculate_rate.png")
```


# Rate = (Current / Last) - 1
```{r, fig.align = 'center', out.width = '100%'}
knitr::include_graphics("./Images/06-2-rates2.png")
```
...
knitr::include_graphics("./Images/06-2-investment1.png")
```
...
1. Regression: Calculate the alpha and the beta

2. Line plot: Market vs Stock Returns

3. Result of \$100 investment in 2021?
...
knitr::include_graphics("./Images/06-2-yahoo1.png")
```


# Yahoo Finance: Download Historical Data
```{r, fig.align = 'center', out.width = '90%'}
knitr::include_graphics("./Images/06-2-yahoo2.png")
```


# Prep the New Data
```{r, fig.align = 'center', out.width = '90%'}
knitr::include_graphics("./Images/06-2-yahoo3.png")
```


# Prep the New Data
```{r, fig.align = 'center', out.width = '50%'}
knitr::include_graphics("./Images/06-2-yahoo4.png")
```


# Prep the New Data
```{r, fig.align = 'center', out.width = '50%'}
knitr::include_graphics("./Images/06-2-yahoo5.png")
```
